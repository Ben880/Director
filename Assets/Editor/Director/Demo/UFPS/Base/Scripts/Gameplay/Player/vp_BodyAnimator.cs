...
public class vp_BodyAnimator : MonoBehaviour
{
	...
	protected vp_PlayerEventHandler Player
	{
		get
		{
			...
			if (m_Player == null)
				m_Player = GameObject.FindWithTag("Player").GetComponentInChildren<vp_PlayerEventHandler>();
			if (m_Player == null)
				m_Player = GameObject.FindWithTag("Player").GetComponentInChildren<vp_FPPlayerEventHandler>();
			return m_Player;
		}
	}
